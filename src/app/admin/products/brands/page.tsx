import ButtonDeleteBrand from '@/app/admin/products/brands/_components/button-delete-brand'
      ...
      <td className='py-3 px-6'>
        <div className='flex items-center gap-2'>
          <Button variant='warning' className='min-w-8 w-7 h-8 p-0 rounded-full'>
            <Link href={`/admin/products/brands/edit/${item?.slug}`}>
    ...
    <Container className='py-12'>
      ...
      <div className='flex items-start justify-between my-4'>
        ...
        <Button variant='primary' size='small'>
          <Link href='/admin/products/brands/add' className='flex items-center gap-2'>
