import ButtonDeleteProductTag from '@/app/admin/products/tags/_components/button-delete-product-tag'
      ...
      <td className='py-3 px-6'>
        <div className='flex items-center gap-2'>
          <Button variant='warning' className='min-w-8 w-7 h-8 p-0 rounded-full'>
            <Link href={`/admin/products/tags/edit/${item?.slug}`}>
    ...
    <Container className='py-12'>
      ...
      <div className='flex items-start justify-between my-4'>
        ...
        <Button variant='primary' size='small'>
          <Link href='/admin/products/tags/add' className='flex items-center gap-2'>
